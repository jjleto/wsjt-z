...
typedef struct dec_data {
  ...
  struct
  {
    ...
    // Decoder port from WSJTX 3.0 / JTDX (must mirror lib/jt9com.f90 params_block)
    char mybcall[12];
    char hisbcall[12];
    int ncandthin;
    int ndtcenter;
    ...
    int nlasttx;
    int ndelay;
    int nmt;                  // FT8 thread count (0 = auto)
    int nft8rxfsens;
    int nft4depth;
    int nsecbandchanged;
    bool nagainfil;
    ...
    bool nhint;
    bool fmaskact;
    bool lmultift8;           // master enable for parallel FT8 decoder
    bool lft8lowth;
    bool lft8subpass;
    bool ltxing;
    bool lhideft8dupes;
