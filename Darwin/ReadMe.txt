                    WSJT-Z for macOS Installation

=================================================

FIRST RUN - Code Signing
...
prevent the app from running on first launch. To authorize it:
  ...
  4. Click Open Anyway and enter your administrator password to authorize it.

SHARED MEMORY SETUP (macOS Monterey and later)

WSJT-Z requires increased shared memory limits. A helper script is provided:

  1. Open Terminal (Applications > Utilities > Terminal)
  2. Run: ./setup-memory.sh

The setup script will check your current limits and apply fixes if needed.
For details, see the script in the DMG or run: ./setup-memory.sh --help

AUDIO CONFIGURATION

  1. Open System Preferences > Sound
  2. Set input and output to 48000 Hz, 16-bit, 2 channels
  3. If using an external audio interface, open Audio MIDI Setup and configure
     your device with the same settings

RADIO CONFIGURATION

For CAT control and serial communication:

  1. Install your radio's USB driver if needed (Silicon Labs drivers are common
     for Icom/Yaesu/Kenwood)
  2. Connect your radio via USB
  3. Open WSJT-Z > Preferences > Radio
  4. Select your serial port from the dropdown (usually /dev/tty.SLAB_USBtoUART)

TIME SYNC

Ensure your Mac clock is accurate:
  
  Open System Preferences > Date & Time and enable automatic date/time sync.

SUPPORT

For issues or questions, visit the WSJT-Z project page or contact the development team.
